                ...
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <a href="#" className="text-sm font-medium text-blue-600 hover:underline dark:text-blue-500" onClick={(e) => { e.preventDefault(); toast.error("Reset password not implemented yet."); }}>
                                Forgot password?
                            </a>
                        </div>
